...
<head>
    ...
    <link rel="stylesheet" href="asset/js\datatables.net-bs4\dataTables.bootstrap4.css">
    <link rel="shortcut icon" type="image/png"
        href="https://www.zarla.com/images/zarla-carevet-1x1-2400x2400-20210809-ctbb9btmp84tpccp4hdr.png?crop=1:1,smart&width=250&dpr=2">
        ...
        <nav class="navbar navbar-expand-lg bg-light">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNavDropdown">
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a class="nav-link active" href="{{ url('/') }}">Registrar</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" href="{{ url('list') }}">Listar</a>
                        </li>
                        <li class="nav-item">
